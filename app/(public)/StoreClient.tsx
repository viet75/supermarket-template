            ...
            <div className="flex justify-center mt-6 mb-2 px-4">
                <div className="relative w-full max-w-2xl">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 shadow-sm focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
                    />
                </div>
            </div>
